  ...
  },
  {
    ...
    "resources": [
      ...
      },
      {
        ...
        "type": "Tool",
        "rating": 8,
        "description": "Scanner for MCP servers, agent skills and plugins that runs thirteen engines over a package and returns one report. Runs offline via npx with no install."
      },
      {
        "title": "SpecLock",
        ...
        "type": "Tool",
        "rating": 8,
        "description": "Enforces the constraints written in CLAUDE.md, AGENTS.md and .cursorrules before an AI coding agent edits a file, runs a shell command or commits, with an override audit trail and an MCP server."
      },
      {
        "title": "rust-norion",
